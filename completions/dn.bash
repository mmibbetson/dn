_dn() {
    ...
    case "${cmd}" in
        dn)
            opts="-h -V --help --version new rename help"
...
if [[ "${BASH_VERSINFO[0]}" -eq 4 && "${BASH_VERSINFO[1]}" -ge 4 || "${BASH_VERSINFO[0]}" -gt 4 ]]; then
    complete -F _dn -o nosort -o bashdefault -o default dn
else
    complete -F _dn -o bashdefault -o default dn
fi
